...
export const RichEditor = (props: ISceneRichTextEditorProps) => {
    ...
    return (
        <>
            ...
            >
                <EditorToolBar editor={editor} mobileTop={mobileConstraints?.top} desktopTop={desktopConstraints?.top} focusMode={props.focusMode} toggleFocusMode={props.toggleFocusMode}>
                    <CheckRepeatsButton
                        editor={editor}
